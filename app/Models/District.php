...
{
    use HasFactory;
    protected $fillable = ['slug', 'province_id', 'name', 'status'];
    // Boot method to handle model events
    protected static function boot()
    {
        parent::boot();

        // Automatically generate a unique slug when creating a district
        static::creating(function ($district) {
            $district->slug = static::generateUniqueSlug();
        });
    }
