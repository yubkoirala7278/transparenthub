                    ...
                    <div class="col-md-3 mb-4">
                        <div class="card custome-shadow hover-effect"
                            ...
                            <div class="card-body">
                                ...
                                <p class="{{ $percentageChangeForCustomer >= 0 ? 'text-success' : 'text-danger' }} mb-0">
                                    <i
                        ...
                        <div class="card custome-shadow hover-effect"
                            ...
                            <div class="card-body">
                                ...
                                <p
                                    ...
                                    <i class="fas fa-arrow-{{ $percentageChangeForMostViewed >= 0 ? 'up' : 'down' }}"></i>
                        ...
                        <div class="card custome-shadow hover-effect"
                            ...
                            <div class="card-body">
                                ...
                                <p
                                    ...
                                    <i class="fas fa-arrow-{{ $percentageChangeForCategories >= 0 ? 'up' : 'down' }}"></i>
            ...
            <div class="tab-pane fade " id="municipalities" role="tabpanel" aria-labelledby="municipalities-tab">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card custome-shadow hover-effect" style="border-radius: 10px; border-left: 5px solid #F1C40F;">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div>
