...
@section('content')
    ...
    <div>
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <a href="{{ route('products_brand.index') }}" class="btn text-white btn-sm rounded-pill px-3 py-2"
        ...
        <div>
            <div class="card shadow" style="border-top:none;">
                <div class="card-header" style="background-color: #2C3E50">
                    <h5 class="mb-0 text-white">Create New Brand</h5>
                </div>
                <div class="card-body">
                    <form action="{{route('products_brand.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            <label for="image" class="font-weight-bold">Upload Brand Image</label>
