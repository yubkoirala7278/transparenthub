        ...
        <div>
            <div class="card shadow" style="border-top:none;">
                <div class="card-header" style="background-color: #2C3E50">
                    <h5 class="mb-0 text-white">Create New Product</h5>
                </div>
                <div class="card-body">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="shipping_returns" name="shipping_returns"
                                                placeholder="Enter the shipping and returns protocol">{{ old('shipping_returns') }}</textarea>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="sku" name="sku"
                                                placeholder="Enter SKU (Stock Keeping Unit)" value="{{ old('sku') }}">
                                            @if ($errors->has('sku'))
                                        ...
                                        <div class="form-group my-3">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="track_qty"
                                                    ...
                                                    {{ old('track_qty', isset($product) && $product->track_qty ? 'checked' : '') }}>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="qty" name="qty"
                                                placeholder="Enter Product Quantity" value="{{ old('qty') }}">
                                            @if ($errors->has('qty'))
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="card shadow bg-white rounded ">
                                    <div class="card-body">
                                        {{-- Category --}}
                                        <div class="form-group">
                                            <label for="category_id" class="font-weight-bold h5">Product Category <span
                                                    class="text-danger">*</span></label>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="is_featured" id="is_featured">
                                                <option value="Yes"
                                                    {{ old('is_featured', 'Yes') === 'Yes' ? 'selected' : '' }}>Yes
                                                </option>
                                                <option value="No"
    ...
    <script>
        $(document).ready(function() {
            ...
            function initSelect2WithSelectAll(selectId) {
                ...
                $(selectId).prepend(selectAllOption); // Prepend "Select All" option
