...
use App\Http\Controllers\admin\professional\ProfileController;
...
Route::get('/get-news-trend-data', [HomeController::class, 'getNewsTrendData']);
Route::get('/get-news-categories-data', [HomeController::class, 'getNewsCategoriesData']);
// profile
...
Route::get('/appointment/{slug}', [AppoinmentController::class, 'show'])->name('appoinment.show');
// });
